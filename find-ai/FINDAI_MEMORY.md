...
> **Last updated:** 2026-04-26 (v3.4.18 — **bill photo verification anti-fraud lattice locked**: ARCH_BILL_VERIFICATION.md spec'd (10-layer multi-signal defense, Tier 1 ships with v1 production at RM 5-10k cost), UI placeholder Verification panel added to score reveal in v0 mock so pilots see the planned 5 fraud-defense checks. Cakap 2.0 · DNA: TRUST BEFORE SIGNING).
