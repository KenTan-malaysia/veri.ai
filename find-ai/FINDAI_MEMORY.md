...
> **Last updated:** 2026-04-26 (v3.4.20 — **ScoreScale redesigned to dual-marker style** matching Ken's analyst-target-price reference. Two markers on gradient bar (Behaviour navy / Trust Score gold) — visual gap shows how evidence depth pulled headline score down. Math row below: Behaviour × Confidence = Trust Score. Cakap 2.0 · DNA: TRUST BEFORE SIGNING).
