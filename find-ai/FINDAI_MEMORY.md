...
> **Last updated:** 2026-04-26 (v3.4.17 — **3 polish landed**: (1) Account # path collapsed to 1-click (was 2-click — Ken's UX call), (2) renamed judgmental tags "Upfront tenant / Late tenant" → "Upfront payment pattern / Late payment pattern" in 3 langs (DNA: describe behaviour not the person), (3) Evidence Scenario toggle on score reveal — DEMO-only segmented control (🌳 Full / 🌿 Partial / 🌱 Limited) shows how SAME tenant gets different Trust Score based on evidence depth, not on character. Cakap 2.0 · DNA: TRUST BEFORE SIGNING).

---

## 🛠️ BUILD APPROACH — locked v3.4.16

**Ken builds Find.ai using AI-assist (Zeus / Claude) for all engineering, not hiring engineers.** Year 1 budget: RM 26-50k (vs RM 60-145k hiring). See full doc: `BUILD_APPROACH.md`.

**Phased spending plan (do NOT pre-spend; gate each phase on real signal):**
- Phase 0 (now): Pilot v0 — RM 100, 4 weeks
- Phase 1: Real OCR + scoring backend — RM 5-15k, 2-3 months (AFTER pilot signal)
- Phase 2: Auth + database + lawyer — RM 8-20k, 1-2 months (AFTER first paying customer)
- Phase 3: Security review — RM 5-10k, 2 weeks (BEFORE broad consumer launch — non-negotiable)
- Phase 4: LHDN partnership + scale — RM 8-15k/month (AFTER 50+ paying customers)

**Hire humans for these (AI cannot do):** Malaysian lawyer (T&C/Privacy/Consent), trademark filings, Sdn Bhd registration, security review before broad launch, LHDN partnership negotiation, sales calls, customer development.

**Time bottleneck warning:** AI-assist requires 20-30 hours/week of Ken's time during build phase. If <20h/week realistic, plan part-time engineer at Phase 2.
