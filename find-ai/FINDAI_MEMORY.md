...
> **Last updated:** 2026-04-25 (v3.4.12 — **repeat users skip Welcome**: "Don't show this again" checkbox above Let's go button persists choice via `localStorage['fi_skip_welcome_v1']`. Returners land directly on Pick screen — back arrow on Pick reverts to Welcome and clears flag. Cakap 2.0 · DNA: TRUST BEFORE SIGNING).
