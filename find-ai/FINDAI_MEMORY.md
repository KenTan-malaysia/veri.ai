...
> **Last updated:** 2026-04-25 (v3.4.6 — **Pilot prep shipped**: recruitment plan + onboarding templates (3 langs) + 10-min Google Forms feedback questionnaire · ready to recruit 5-10 friendly Malaysian landlords to validate concept BEFORE backend investment · Cakap 2.0 · DNA: TRUST BEFORE SIGNING).
