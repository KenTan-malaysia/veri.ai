...
export default function Landing({ onStart, lang, setLang, hasSavedChat, onContinueChat }) {
  const t = {
    en: {
      ...
      heroB: 'landlord law,',
      heroC: 'answered.',
      sub: 'Deposits, evictions, stamp duty, bad tenants — get law, steps, costs, and clauses. Instant.',
      cta: 'Start free →',
    ...
    bm: {
      ...
      heroC: 'dijawab.',
      sub: 'Deposit, pengusiran, duti setem, penyewa bermasalah — dapat undang-undang, langkah, kos, dan klausa. Segera.',
      cta: 'Mula percuma →',
    ...
    zh: {
      ...
      heroB: '房东法律，',
      heroC: '即刻解答。',
      sub: '押金、驱逐、印花税、问题租客 — 获得法律条款、步骤、费用和合约条款。即时。',
      cta: '免费开始 →',
      continueBtn: '继续上次对话',
      toggle: 'EN',
      free: '无需注册。免费试用。',
